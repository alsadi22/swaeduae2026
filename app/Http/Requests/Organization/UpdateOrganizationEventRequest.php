...
class UpdateOrganizationEventRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()->can('configureInOrganizationPortal', $event);
    }

    public function rules(): array
    {
        return (new StoreOrganizationEventRequest)->rules();
    }
