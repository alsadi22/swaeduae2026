    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="post" action="{{ route('admin.external-news-sources.update', $source) }}" class="space-y-6">
                    @csrf
                    @method('put')
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg border border-red-100">
                ...
                <form method="post" action="{{ route('admin.external-news-sources.destroy', $source) }}" class="mt-4" onsubmit="return confirm(@json(__('Delete this source and its fetch logs? Imported items will be removed.')));">
                    @csrf
                    @method('delete')
