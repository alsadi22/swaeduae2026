    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="post" action="{{ route('admin.cms-pages.update', $page) }}" class="p-6 space-y-6">
                    @csrf
                    @method('put')
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <a href="{{ route('admin.cms-pages.preview', $page) }}?lang={{ $page->locale }}" target="_blank" rel="noopener" class="text-sm text-indigo-600 hover:text-indigo-900">{{ __('Preview') }}</a>
